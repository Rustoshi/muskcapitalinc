...
const navItems = [
    ...
    { name: "Memberships", href: "/admin/memberships", icon: "M15 9a2 2 0 10-4 0v5a2 2 0 01-2 2h6m-6-4h4m8 0a9 9 0 11-18 0 9 9 0 0118 0z" },
    ...
    { name: "Projects", href: "/admin/projects", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
